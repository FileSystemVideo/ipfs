...
func (bh *RoutedHost) Ping(pi peer.AddrInfo, timeout time.Duration) error {
	return bh.host.Ping(pi,timeout)
}
...
func (h *RoutedHost) GetNatStatus() network.Reachability{
	return h.host.GetNatStatus()
}
